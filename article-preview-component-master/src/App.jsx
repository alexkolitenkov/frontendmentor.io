...
export default function App() {
  ...
  const btnTooltipRef = useRef();
  const tooltipRef = useRef();
  const btn = useRef();
  const path = useRef();

  const hoverBtn = () => {
    btn.current.style.backgroundColor =  "var(--desaturated-dark-blue)";
    path.current.style.fill =  "var(--light-grayish-blue)";
  }
  const hoverOutBtn = () => {
    btn.current.style.backgroundColor =  "var(--light-grayish-blue)";
    path.current.style.fill =  "#6E8098";
  }
  function handleClick() {
    btnTooltipRef.current.style.backgroundColor = btnTooltipRef.current.style.backgroundColor === "var(--very-dark-grayish-blue)" ? "transparent" : "var(--very-dark-grayish-blue)";
    tooltipRef.current.style.visibility = tooltipRef.current.style.visibility === "visible" ? "hidden" : "visible";
    btn.current.style.backgroundColor = btn.current.style.backgroundColor === "var(--desaturated-dark-blue)" ? "var(--light-grayish-blue)" : "var(--desaturated-dark-blue)";
    path.current.style.fill = path.current.style.fill === "var(--light-grayish-blue)" ? "#6E8098" : "var(--light-grayish-blue)";
  }
        ...
        <div className="card">
          ...
          <div className="info-block">
            ...
            <div className="author-share">
              <div ref={authorRef} className="author">
              ...
              <div ref={btnTooltipRef} className="btn-tooltip">
                <div ref={tooltipRef} className="tooltip">
                  <p>Share</p>
                  <ul className="tooltip-links">
                    <li>
                ...
                <button ref={btn} onClick={handleClick} onMouseOver={hoverBtn} onMouseOut={hoverOutBtn}>
                  <svg xmlns="http://www.w3.org/2000/svg" role="img" aria-describedby="shareIcon"
                    width="15"
                    height="13">
                    <path ref={path} fill="#6E8098" d="M15 6.495L8.766.014V3.88H7.441C3.33 3.88 0 7.039 0 10.936v2.049l.589-.612C2.59 10.294 5.422 9.11 8.39 9.11h.375v3.867L15 6.495z" />
                  </svg>
                </button>
              </div>
